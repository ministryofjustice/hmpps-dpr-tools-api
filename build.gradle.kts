...
dependencies {
  ...
  implementation("uk.gov.justice.service.hmpps:hmpps-digital-prison-reporting-lib:9.4.3")
  implementation("com.google.code.gson:gson:2.11.0")
  implementation("software.amazon.awssdk:redshiftdata:2.31.24")
  implementation("software.amazon.awssdk:athena:2.32.28")
  implementation("software.amazon.awssdk:sts:2.32.28")
