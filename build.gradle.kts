...
dependencies {
  ...
  implementation("uk.gov.justice.service.hmpps:hmpps-digital-prison-reporting-lib:9.4.5")
  implementation("com.google.code.gson:gson:2.11.0")
  implementation("software.amazon.awssdk:redshiftdata:2.31.24")
  implementation("software.amazon.awssdk:athena:2.35.4")
  implementation("software.amazon.awssdk:sts:2.35.4")
